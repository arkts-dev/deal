 ...
 *    post-state: no survivors, sessions, or open battery fds;
...
static void dealpg4_battery_cleanup(dealpg4_probe_bound *bound)
{
    (void)dealpg4_reap_all_bounded(
        bound, dealpg4_now_ms() + DEALPG4_BATTERY_CLEANUP_GRACE_MS);
}
